...
namespace Microsoft.MixedReality.Toolkit.SDK.UX.Interactable.Events
{
    ...
    public class InteractableGestureReceiver : ReceiverBase
    {
        ...
        [InspectorField(Type = InspectorField.FieldTypes.GameObject, Label = "Gestuer Manipulator", Tooltip = "A GameObject containing a InteractableGestureManipulator")]
        ...
        public override void OnUpdate(InteractableStates state, Interactable source)
        {
            ...
            if (pointerCount >= PointerMinimum || updated)
            {
                ...
                {
                    GameObject gameObject = (GameObject)Manipulators;
                    if (gameObject != null)
                    {
                        InteractableGestureManipulator manipulator = gameObject.GetComponent<InteractableGestureManipulator>();
                        if (manipulator != null)
