...
{
    /// <summary>
    /// An effect component that will scale and fade a gameObject over it's LifeSpan, then destroy itself at the end.
    /// This is used as glow or burst to get attention or add interaction feedback.
    /// </summary>
