...
{
    /// <summary>
    /// Scales the object based on the specified vector compared to the AnchorTransform
    /// Offset will at a consistant value to scaled value.
    /// </summary>
    [ExecuteInEditMode]
    public class PanelTransformScale : MonoBehaviour
    {
