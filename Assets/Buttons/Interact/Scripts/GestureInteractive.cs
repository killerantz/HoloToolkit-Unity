...
namespace Interact
{
    ...
    public class GestureInteractive : Interactive, ISourceStateHandler
    {
        ...
        private IInputSource tempInputSource;
        ...
        public override void OnInputDown(InputEventData eventData)
        {
            ...
            tempInputSource = eventData.InputSource;
            tempInputSourceId = eventData.SourceId;
        ...
        private void HandleStartGesture()
        {
            ...
            startHeadPosition = CameraCache.Main.transform.position;
            startHeadRay = CameraCache.Main.transform.forward;
        ...
        public override void OnInputUp(InputEventData eventData)
        {
            ...
            if (currentInputSource != null && (eventData == null || eventData.SourceId == currentInputSourceId))
            {
                HandleRelease(false);
            }
